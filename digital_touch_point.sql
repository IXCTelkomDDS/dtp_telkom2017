...
--
-- Host: 127.0.0.1
-- Generation Time: 31 Jan 2018 pada 11.00
-- Versi Server: 5.6.16
-- PHP Version: 5.5.9
...
CREATE TABLE IF NOT EXISTS `upload_dtp` (
  `ID_UPLOAD` int(11) NOT NULL AUTO_INCREMENT,
  `TGL_UPLOAD` date NOT NULL,
  `JUDUL_UPLOAD` varchar(10000) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `DESKRIPSI_UPLOAD` varchar(10000) COLLATE utf8_unicode_ci NOT NULL,
  `NAMA_FILE_UPLOAD` varchar(1000) COLLATE utf8_unicode_ci NOT NULL,
...
(12, '2018-01-19', 'SNMP Proxy', 'Kajian', 'SOB', '[Private] Telkom''s SNMP based Network Performance Monitoring Simplification Proposal', '', ''),
...
(2, 'lutfi', 'lutfi', 'IXC', 'User P.I.C'),
(8, 'ambar', 'ambar', 'BAN', 'User P.I.C'),
(9, 'kai', 'kai', 'BCN', 'User P.I.C');
