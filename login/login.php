        ...
        <div class="form-block w-form">
			...
			<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="acc_login.php" id="wf-form-Input-Form" name="form-upload" data-name="Input Form">
				...
				<label for="username" class="field-label" style="width:300px; color:black;">Username</label>
					<input type="text" class="text-field w-input" autofocus="true" name="username" data-name="username" placeholder="Enter Username" id="username" required="" value="<?php if(isset($_COOKIE["username"])) { echo $_COOKIE["username"]; } ?>">
					
				<label for="password" class="field-label" style="width:300px; color:black;">Password</label>
					<input type="password" class="text-field w-input" autofocus="true" name="password" data-name="password" placeholder="Enter Password" id="password" required="" value="<?php if(isset($_COOKIE["password"])) { echo $_COOKIE["password"]; } ?>">
