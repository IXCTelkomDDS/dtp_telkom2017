...
<?php
	...
	$no = 1;
	$sql = "SELECT * FROM user_pic WHERE user_type = 'User P.I.C' ORDER BY id_pic ASC";
	$result = mysqli_query($connect, $sql);

?>


	<title>User P.I.C</title>
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title" style="font-weight: bold; font-size: 40px; margin-top: 10px;">USER P.I.C</h3>
										...
										<tbody style="font-size: 16px;">
											<tr>
												...
												<td> <a class="btn btn-primary" onclick="return konfirmasi2();" href="update_user.php?id=<?php echo $data['id_pic'];?>" style="font-weight: bold;">Update</a>
								      					&nbsp;
								      				<a class="btn btn-primary" onclick="return konfirmasi();" href="../act_delete_adminUser.php?id=<?php echo $data['id_pic'];?>" style="font-weight: bold;">Delete</a>
								    			</td>
