						...
						<div class="content" style="padding-bottom: 30px;">
							...
							<form class="form-auth-small" role="form" method="post" enctype="multipart/form-data" action="">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" required="" name="phone" value="<?php echo $data['phone'];?>">
								</div>
								<div class="form-group">
								...
								<div style="padding-top: 10px; padding-bottom: 20px;" class="container-login100-form-btn m-t-17">
									<button class="btn btn-primary btn-lg btn-block" type="submit" value="Submit" name="Update Admin" style="font-weight: bold; height: 40px;"> EDIT </button>
								</div>
