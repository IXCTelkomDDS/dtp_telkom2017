...
<body class="body-2">
  <div data-collapse="medium" data-animation="default" data-duration="400" class="navbar w-nav">
    <div class="container-7 w-container"><a href="#" class="w-nav-brand"><img src="images/logo-telkom.png" width="80.5"></a>
      <nav role="navigation" class="w-nav-menu"><a href="index.html" id="home" class="navlink w-nav-link">Home</a><a href="ban-page.html" id="about" class="navlink w-nav-link">About BAN</a><a href="#doc-std" id="about" class="navlink w-nav-link">Doc. Standard</a><a href="#End-Section" class="navlink w-nav-link">Customer Care</a></nav>
