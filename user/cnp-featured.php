...
<?php
	...
	$reload = "cnp-featured.php?pagination=true";
	$sql2 = "SELECT * FROM upload_dtp WHERE JENIS_FILE_UPLOAD = 'Prototype' AND UNGGULAN = 'Unggulan' AND JENIS_LAB_UPLOAD = 'CNP' ORDER BY ID_UPLOAD ASC";
	$result2 = mysqli_query($connect, $sql2);

?>


		<title>List of Featured Products CNP</title>
								...
								<nav class="navbar navbar-default" role="navigation">
										...
										<div class="collapse navbar-collapse scrollspy smooth-scroll" id="navbar-collapse-1">
											<ul class="nav navbar-nav navbar-left">
												...
												<li><a href="cnp-standardization.php" style="font-weight: bold;">Doc. Standardization</a></li>
		...
		<div class="section clearfix object-non-visible" data-animation-effect="fadeIn" style="background-color: white;">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-12">
						<h1 id="featured" class="title text-center" style="font-weight: bold;">List of Featured Products CNP</h1>
						<div class="space"></div>
