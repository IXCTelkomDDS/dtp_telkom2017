...
<?php
	...
	$reload = "ixc-standardization.php?pagination=true";
								...
								<nav class="navbar navbar-default" role="navigation">
										...
										<div class="collapse navbar-collapse scrollspy smooth-scroll" id="navbar-collapse-1">
											<ul class="nav navbar-nav navbar-left">
												...
												<li><a href="ixc-featured.php" style="font-weight: bold;">Featured Products</a></li>
		...
		<div class="section clearfix object-non-visible" data-animation-effect="fadeIn" style="background-color: white;">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-12">
						<h1 id="standardization" class="title text-center" style="font-weight: bold;">List of Doc. Standardization IXC</h1>
						<div class="space"></div>
