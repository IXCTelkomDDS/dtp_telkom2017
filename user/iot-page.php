    ...
    <div class="row-18 w-row">
      ...
      <div class="column-48 w-col w-col-4">
        <div class="about research">
          ...
          <p class="paragraph-ixc responsibility">Daftar Kajian<br>Lab Infrastructure Service Research</p><a href="iot-kajian.php" class="link-10">Load more . . .</a></div>
        <div class="about research">
          <h1 class="heading-17">standard documents</h1>
          <p class="paragraph-ixc responsibility">Daftar Dokumen Standarisasi<br>Lab Infrastructure Service Research</p><a href="iot-dokumen-standard.php" class="link-10">Load more . . .</a></div>
      </div>
    </div>
  </div>
