...
<?php
	...
	$reload = "ixc-review.php?pagination=true";
...
?>
		...
		<title>List of Reviews IXC</title>
		...
		<div class="section clearfix object-non-visible" data-animation-effect="fadeIn" style="background-color: white;">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-12">
						<h1 id="review" class="title text-center" style="font-weight: bold;">List of Reviews IXC</h1>
						<div class="space"></div>
